...
INSERT INTO scholarship (name, type, nominal, deadline, duration, description, general_requirement, special_requirement, status, created_at, degree_requirement) VALUES
('Beasiswa Unggulan Sigma 2025', 'Penuh', 1500000, '2025-06-30', '4 ', 'Beasiswa penuh untuk mahasiswa berprestasi dari berbagai jurusan. Mencakup biaya kuliah, tunjangan hidup, dan pengembangan diri.', 'WNI, IPK min 3.50, aktif organisasi, tidak sedang menerima beasiswa lain.', 'Esai motivasi, surat rekomendasi dosen, wawancara.', 'Aktif', '2025-04-30 17:00:00', 'S1/D4'),
('Beasiswa Riset Inovasi', 'Parsial', 1000000, '2025-06-15', '1 ', 'Dukungan finansial untuk proyek riset inovatif di bidang teknologi dan sains.', 'WNI, mahasiswa S1/S2, proposal riset inovatif, IPK min 3.25.', 'Presentasi proposal, surat rekomendasi pembimbing.', 'Aktif', '2025-05-04 17:00:00', 'S1/S2'),
('Beasiswa Talenta IT', 'Penuh', 1200000, '2025-07-20', '3 ', 'Beasiswa khusus bagi mahasiswa dengan minat dan bakat di bidang teknologi informasi.', 'WNI, mahasiswa D3/S1 jurusan IT, portofolio proyek IT, IPK min 3.00.', 'Uji kompetensi teknis, wawancara.', 'Aktif', '2025-05-09 17:00:00', 'D3/S1'),
('Beasiswa Pendidikan Guru', 'Parsial', 750000, '2025-07-01', '2 ', 'Mendukung calon guru berdedikasi untuk pendidikan di daerah terpencil.', 'WNI, mahasiswa jurusan pendidikan, bersedia ditempatkan di daerah terpencil, IPK min 3.00.', 'Surat komitmen, wawancara.', 'Aktif', '2025-05-11 17:00:00', 'S1'),
('Beasiswa Seni & Budaya', 'Penuh', 1300000, '2025-08-01', '2 ', 'Beasiswa untuk mahasiswa yang berprestasi di bidang seni dan budaya.', 'WNI, mahasiswa jurusan seni/budaya, portofolio karya, IPK min 3.00.', 'Audisi/pameran karya, wawancara.', 'Aktif', '2025-05-14 17:00:00', 'S1'),
('Beasiswa Kewirausahaan Muda', 'Parsial', 800000, '2025-08-15', '1.5 ', 'Dukungan bagi mahasiswa dengan ide bisnis inovatif dan potensi kewirausahaan.', 'WNI, mahasiswa S1/D3, proposal bisnis, IPK min 2.80.', 'Presentasi ide bisnis, wawancara.', 'Aktif', '2025-05-17 17:00:00', 'D3/S1'),
('Beasiswa Lingkungan Berkelanjutan', 'Penuh', 1400000, '2025-09-01', '3 ', 'Beasiswa untuk mahasiswa yang berdedikasi pada isu lingkungan dan pembangunan berkelanjutan.', 'WNI, mahasiswa S1/S2 jurusan relevan, terlibat dalam kegiatan lingkungan, IPK min 3.30.', 'Esai tentang isu lingkungan, wawancara.', 'Aktif', '2025-05-19 17:00:00', 'S1/S2'),
('Beasiswa Olahraga Berprestasi', 'Parsial', 900000, '2025-09-10', '2 ', 'Dukungan bagi atlet mahasiswa yang mengharumkan nama bangsa di kancah olahraga.', 'WNI, mahasiswa aktif, memiliki prestasi olahraga tingkat nasional/internasional, IPK min 2.75.', 'Sertifikat prestasi, surat rekomendasi pelatih.', 'Aktif', '2025-05-21 17:00:00', 'S1'),
('Beasiswa Internasional Sigma', 'Penuh', 2000000, '2025-10-01', '4 ', 'Beasiswa untuk studi di luar negeri bagi mahasiswa berprestasi.', 'WNI, IPK min 3.70, kemampuan bahasa Inggris (TOEFL/IELTS), surat penerimaan universitas luar negeri.', 'Esai, wawancara, tes potensi akademik.', 'Aktif', '2025-05-24 17:00:00', 'S1/S2'),
('Beasiswa Djarum Super', 'Penuh', 500000, '2025-05-31', '4 ', 'Beasiswa Djarum Super Gelombang 1 hadir untuk membantu meringankan biaya pendidikanmu.', 'Warga Negara Indonesia (WNI). Terdaftar sebagai mahasiswa aktif di [Nama Universitas/Institusi] untuk jenjang [Sebut jenjang, misal: S1, S2] pada  akademik [Tahun Akademik]. Memiliki Indeks Prestasi Kumulatif (IPK) minimal [Sebut IPK Minimal, misal: 3.00] dari skala 4.00. Tidak sedang menerima beasiswa lain dari sumber lain.', 'Surat rekomendasi dari [Sebut Pemberi Rekomendasi, misal: Dosen Pembimbing Akademik]. Esai dengan tema [Sebut Tema Esai]. Surat pernyataan tidak mampu (jika beasiswa diperuntukkan bagi mahasiswa kurang mampu). Sertifikat prestasi akademik atau non-akademik (jika ada).', 'Aktif', '2025-05-19 17:00:00', 'S1');
